...
class IbottaScraper(object):
    ...
    If class does not work you may need to get new 'X-App-Token' or 'Cookie' by:
        ...
        2. With google dev tools
            ...
            c. scroll to 'request-headers' section. replace 'X-App-Token' and 'Cookie' of class 'self.header' with new values in 'request-headers' section.
    '''
    def __init__(self):
        self.time = time.time()
        ...
        self.header = {
            ...
            'X-App-Token': 'lyWreHoghkuWyed6:1477942768:395b08062357d3806934b6b1d3f51fb951e56c3a',
            ...
            'If-Modified-Since': 'Mon, 31 Oct 2016 19:00:00 GMT',
            }
